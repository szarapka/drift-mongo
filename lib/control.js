import MongoDBService from "./mongo.js";
...
export default class Control {
    ...
    async loadConfig() {
        try {
            ...
            this.dbService = new MongoDBService(c.envs[this.ENV].mongo_host, c.envs[this.ENV].mongo_db);
            return c;
        }
        catch (err) {
    ...
    async getMigrationStatus(persist = false) {
        ...
        const collection = this.dbService.getCollection(this.CONFIG.envs[this.ENV].mongo_collection);
